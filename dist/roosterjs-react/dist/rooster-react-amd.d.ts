 ...
 */
export function createDefaultHtmlSanitizerOptions(): Required<HtmlSanitizerOptions>;
 ...
 * false to keep original foramt
 */
export type CreatePasteFragment = (core: EditorCore, clipboardData: ClipboardData, position: NodePosition, pasteAsText: boolean, applyCurrentStyle: boolean) => DocumentFragment;
 ...
 * Core paste plugin for handling onPaste event and extract the pasted content
 */
export class CorePastePlugin implements EditorPlugin {
    private editor;
    private disposer;
    getName(): string;
    initialize(editor: Editor): void;
 ...
 */
export function rotateElement(editor: Editor, element: HTMLElement, angle: number): void;
...
export function registerDefaultString(category: string, strings: Strings): void;

export function getString(category: string, name: string, strings?: Strings): string;

export const NullFunction: (...args: any[]) => any;
 ...
 * Indentation.Increase to increase indentation or Indentation.Decrease to decrease indentation
 */
export function setNonCompatIndentation(editor: Editor, indentation: Indentation): void;
 ...
 * @param editor The editor instance
 */
export function toggleNonCompatBullet(editor: Editor): void;
 ...
 * @param editor The editor instance
 */
export function toggleNonCompatNumbering(editor: Editor): void;

export function css(...args: (string | any)[]): string;

export function getDataAndAriaProps<T>(props: any): T;

export class ImageManager implements ImageManagerInteface {
    private static Id;
...
export class DoubleClickImagePlugin implements EditorPlugin {
...
export class PasteImagePlugin implements EditorPlugin {
...
export class IgnorePasteImagePlugin implements EditorPlugin {
    private editor;
...
export class UndoWithImagePlugin extends Undo {
    private imageManager;
    private bufferSize;
    /**
     * Create an instance of Undo
...
export class RoosterCommandBar extends React.PureComponent<RoosterCommandBarProps, RoosterCommandBarState> {
...
export class RoosterCommandBarPlugin implements EditorPlugin, RoosterCommandBarPluginInterface {
    private options;
...
export interface RoosterCommandBarPluginInterface {
    getEditor: () => Editor;
    registerRoosterCommandBar: (commandBar: RoosterCommandBar) => void;
    unregisterRoosterCommandBar: (commandBar: RoosterCommandBar) => void;
    promptForLink: () => void;
...
export function getIconOnRenderDelegate(highContrastAssetName?: string, ...assets: {
    name: string;
    className?: string;
}[]): ButtonOnRenderDelegate;

export function getIconOnRenderDelegateWithCustomCacheKey(customCacheKey: string, highContrastAssetName?: string, ...assets: {
    name: string;
    className?: string;
}[]): ButtonOnRenderDelegate;
...
export function createEditorViewState(initialContent?: string, options?: SanitizeHtmlOptions): EditorViewState;
...
export class FocusOutShell extends React.PureComponent<FocusOutShellProps, FocusOutShellState> {
...
export class LeanRooster extends React.Component<LeanRoosterProps, {}> {
    private _contentDiv;
    private _editor;
    private _mode;
...
export class EmojiPlugin implements LeanRoosterPlugin {
    private options;
    private _editor;
 ...
 * @param isReadonly Whether the entity will be a readonly entity
 */
export function createEntityWrapper(editor: Editor, type: string, contentNode: Node, isBlock: boolean, isReadonly: boolean): HTMLElement;
